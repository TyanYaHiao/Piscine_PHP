...
if ($argc == 2) {
	$date = $argv[1];
	if (!preg_match("/^([Ll]undi|[Mm]ardi|[Mm]ercredi|[Jj]eudi|[Vv]endredi|[Ss]amedi|[Dd]imanche) ([0-9]{1,2}) ([Jj]anvier|[Ff]évrier|[Mm]ars|[Aa]vril|[Mm]ai|[Jj]uin|[Jj]uillet|[Aa]oût|[Ss]eptembre|[Oo]ctobre|[Nn]ovembre|[Dd]écembre) ([0-9]{4}) ([0-9]{2}:[0-9]{2}:[0-9]{2})/", $date)) {
		exit("Wrong Format\n");
	}
	...
	$date = preg_replace("/[Ff]évrier/", "February", $date);
	...
	$date = preg_replace("/[Aa]oût/", "August", $date);
	...
	$date = preg_replace("/[Dd]écembre/", "December", $date);
